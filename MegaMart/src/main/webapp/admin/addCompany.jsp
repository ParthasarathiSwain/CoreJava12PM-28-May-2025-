					...
					<div class="col-xl-9 mx-auto">
						...
						<div class="card">
							<div class="card-body">
							 ...
							 <form  id="Catform">
							 	<input class="form-control form-control-lg mb-3" type="text" name="catName"  placeholder="Category Name" aria-label=".form-control-lg example" required>
							 	<input type="hidden" name="secret" value="addCategory">
