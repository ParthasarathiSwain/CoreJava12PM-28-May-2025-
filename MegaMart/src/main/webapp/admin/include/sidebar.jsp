        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          <div class="sidebar-header">
            ...
            <div>
              <h4 class="logo-text">Mega-Mart</h4>
            </div>
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> 
                	<a href="addCategory.jsp"><i class="bi bi-arrow-right-short"></i>Add Category</a>
                </li>
                <li> 
                	<a href="viewCategory.jsp"><i class="bi bi-arrow-right-short"></i>View Category</a>
                </li>
            ...
            <li>
             ...
             <li>
              ...
              <ul>
                <li> 
                	<a href="addAdmin.jsp"><i class="bi bi-arrow-right-short"></i>Add Admin</a>
                </li>
                <li> 
                	<a href="viewAdmin.jsp"><i class="bi bi-arrow-right-short"></i>View Admin</a>
                </li>
