			      ...
			      <div class="modal-body">
			        <div class="container">
			        	<form id="myForm">
								...
								<input type="hidden" value="updateAdmin" name="secret">
								<input class="form-control btn btn-primary" type="submit" value="Update Admin">
							</form>
			        </div>
			      </div>
	...
	function getData(){
  						...
  						if(response.hasOwnProperty(key)){
							...
							s+="<img src='../image/userImg/"+response[key].uImg+"' class='rounded-circle' width='44' height='44' alt=''>";
  	                        ...
  	                        if(response[key].status=="Block"){
  	                        	...
  	                        	s+="<td><div class='table-actions d-flex align-items-center gap-3 fs-6'>";
  	   	                        s+="<a  class='text-primary editAdmin' id='"+response[key].pId+"' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Edit'><i class='bi bi-pencil-fill'></i></a>";
     ...
     $(document).on('click','.editAdmin',function(){
 		...
 		$.ajax({
 			url:"../AdminServlet",
 			type:"Post",
 			data:{"secret":"getAdminDataById","id":uId},
 			dataType:"json",
 			success:function(response){
